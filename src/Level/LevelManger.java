...
//		for (int i = 0; i < 26; i++) {
//				if (i > 0 && i < 25) {
//					g.drawImage(levelsprite[2], Game.TILES_SIZE * i, 0, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//			}
//			if (i == 0) {// ô nối 2
...
//
//			for (int j = 12; j < 13; j++) {	
//					g.drawImage(levelsprite[6], 0, Game.TILES_SIZE * j, Game.TILES_SIZE, Game.TILES_SIZE, null);
//			}
//
//		// tường ngang dưới 3
//		for (int i = 11; i < 17; i++) {
...
//		// tường dọc nhỏ 3
//			for (int j = 12; j < 14; j++) {
//				g.drawImage(levelsprite[7], Game.TILES_SIZE * 17, Game.TILES_SIZE * j, Game.TILES_SIZE, Game.TILES_SIZE, null);
//			}
//		// tường dọc nhỏ 4
//			for (int j = 12; j < 14; j++) {
//
//				g.drawImage(levelsprite[7], Game.TILES_SIZE * 20, Game.TILES_SIZE * j, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//			}
//		/*----------*/
//		// tường ngang dưới 4
...
//		// tường nối 4
//
//		g.drawImage(levelsprite[10], Game.TILES_SIZE * 25, Game.TILES_SIZE * 12, Game.TILES_SIZE, Game.TILES_SIZE,
//				null);
//
//		// tường nối 5
//
//		g.drawImage(levelsprite[9], Game.TILES_SIZE * 25, 0, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*-----------*/		
//		g.drawImage(leveldecor[5], Game.TILES_SIZE * 23, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		g.drawImage(leveldecor[5], Game.TILES_SIZE * 24, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*---------*/
//
//		/* các bật thềm */
...
//		}
//		g.drawImage(leveldecor[5], Game.TILES_SIZE * 9, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[5], Game.TILES_SIZE * 11, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[5], Game.TILES_SIZE * 10, Game.TILES_SIZE * 5, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		for (int i = 12; i < 14; i++) {
//
...
//		/*------ cửa sổ trái*/
//
//		g.drawImage(leveldecor[0], Game.TILES_SIZE * 4, Game.TILES_SIZE * 2, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[1], Game.TILES_SIZE * 5, Game.TILES_SIZE * 2, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[2], Game.TILES_SIZE * 4, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[3], Game.TILES_SIZE * 5, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*----*/
//		/*---cửa sổ phải*/
//
//		g.drawImage(leveldecor[0], Game.TILES_SIZE * 18, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[1], Game.TILES_SIZE * 19, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[2], Game.TILES_SIZE * 18, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(leveldecor[3], Game.TILES_SIZE * 19, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*--------cửa màn------*/
//
//		g.drawImage(levelclosing[0], Game.TILES_SIZE * 1, Game.TILES_SIZE * 7, 128, 128, null);
//  
//		
//		/*-------Mosnter1----*/
//
//				g.drawImage(monster_thung[0], Game.TILES_SIZE * 21, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		for (int i = 17; i < 19; i++) {
//				g.drawImage(monster_thung[1], Game.TILES_SIZE * i, Game.TILES_SIZE * 6, Game.TILES_SIZE,Game.TILES_SIZE, null);
//		}
//		for (int i = 2; i < 4; i++) {
//				g.drawImage(monster_thung[2], Game.TILES_SIZE * i, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//			}
//				g.drawImage(monster_thung[2], Game.TILES_SIZE * 12, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//				g.drawImage(monster_thung[0], Game.TILES_SIZE * 16, Game.TILES_SIZE * 10, Game.TILES_SIZE, Game.TILES_SIZE, null);
//				g.drawImage(ping_tatic[1], Game.TILES_SIZE * 11, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//				g.drawImage(ping_tatic[0], Game.TILES_SIZE *6 , Game.TILES_SIZE*6, Game.TILES_SIZE, Game.TILES_SIZE, null);
//				g.drawImage(ping_tatic[1], Game.TILES_SIZE * 10, Game.TILES_SIZE * 9, Game.TILES_SIZE, Game.TILES_SIZE, null);
//				g.drawImage(ping_tatic[1], Game.TILES_SIZE * 23, Game.TILES_SIZE * 9, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*---------------*/
//		/*-----tảng đá lớn----*/
//			for (int j = 10; j < 12; j++) {
//
//				g.drawImage(thung[0], Game.TILES_SIZE * 8, Game.TILES_SIZE * j, Game.TILES_SIZE, Game.TILES_SIZE, null);
//			}
//
//				g.drawImage(thung[0], Game.TILES_SIZE * 9, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		for (int i = 9; i < 11; i++) {
//				g.drawImage(thung[0], Game.TILES_SIZE * i, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//			} 
//			for (int j = 10; j < 12; j++) {
//				g.drawImage(thung[0], Game.TILES_SIZE * 10, Game.TILES_SIZE * j, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//			}
//		/*----------*/
//
//		/*------bomoff-----*/
//
//		g.drawImage(bom_off[0], Game.TILES_SIZE * 9, Game.TILES_SIZE * 10, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(bom_off[0], Game.TILES_SIZE * 10, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(bom_off[0], Game.TILES_SIZE * 15, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*---------------*/
//
//		/*-------cannon and ping_cannon--------*/
//		g.drawImage(idle_cannon[0], Game.TILES_SIZE * 23, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(ping_cannon[0], Game.TILES_SIZE * 24, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*----------king_ping-----------*/
//
//		g.drawImage(thung[0], Game.TILES_SIZE * 19, Game.TILES_SIZE * 13, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		g.drawImage(thung[0], Game.TILES_SIZE * 18, Game.TILES_SIZE * 13, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		g.drawImage(king_ping[0], Game.TILES_SIZE * 19, Game.TILES_SIZE * 12, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		/*--------------*/
//		/*-----thung---------*/
//
//		g.drawImage(thung[0], Game.TILES_SIZE * 16, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//		g.drawImage(box_king[0], Game.TILES_SIZE * 8, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		for(int i=23; i<25; i++) {
//			for(int j=10; j<12; j++) {
//			g.drawImage(thung[0], Game.TILES_SIZE * i, Game.TILES_SIZE * j, Game.TILES_SIZE, Game.TILES_SIZE, null);
//			}
//		}
//		/*-------------------------*/
//		/*----liveBar--------*/
//		g.drawImage(live_bar[0], Game.TILES_SIZE * 3, Game.TILES_SIZE * 13, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		g.drawImage(live_bar[1], Game.TILES_SIZE * 4, Game.TILES_SIZE * 13, Game.TILES_SIZE, Game.TILES_SIZE, null);
//		
//	}
...
//	g.drawImage(king_ping[0],Game.TILES_SIZE*24,Game.TILES_SIZE*6,Game.TILES_SIZE,Game.TILES_SIZE,null);//vua
	...
	/*---------monster------------*/
//	g.drawImage(ping_tatic[1],Game.TILES_SIZE*16,Game.TILES_SIZE*7,Game.TILES_SIZE,Game.TILES_SIZE,null);
//	
//	g.drawImage(ping_cannon[0],Game.TILES_SIZE*15,Game.TILES_SIZE*2,Game.TILES_SIZE,Game.TILES_SIZE,null);
//	g.drawImage(idle_cannon[0],Game.TILES_SIZE*14,Game.TILES_SIZE*2, 70, 70,null);
//	for(int i = 7;i<9;i++){
//
//		g.drawImage(monster_thung[0], Game.TILES_SIZE * i, Game.TILES_SIZE * 6, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//	}
//	for(int i = 10;i<12;i++){
//
//		g.drawImage(monster_thung[0], Game.TILES_SIZE * i, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//	}
//	g.drawImage(monster_thung[0], Game.TILES_SIZE * 15, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//
//	g.drawImage(monster_thung[0], Game.TILES_SIZE * 4, Game.TILES_SIZE * 9, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	g.drawImage(monster_thung[0],Game.TILES_SIZE*21,Game.TILES_SIZE*7,Game.TILES_SIZE,Game.TILES_SIZE,null);
//	g.drawImage(ping_tatic[1], Game.TILES_SIZE * 20, Game.TILES_SIZE * 2, Game.TILES_SIZE, Game.TILES_SIZE, null);
	/*------------thung-----------*/
//	g.drawImage(thung[0],Game.TILES_SIZE*14,Game.TILES_SIZE*3,70,64,null);
//	g.drawImage(thung[0],Game.TILES_SIZE*15,Game.TILES_SIZE*3,70,64,null);
//	g.drawImage(thung[0], Game.TILES_SIZE * 20, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	g.drawImage(thung[0], Game.TILES_SIZE * 20, Game.TILES_SIZE * 3, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	g.drawImage(thung[0], Game.TILES_SIZE * 20, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	for(int i=23;i<25; i++) {
//		g.drawImage(thung[0], Game.TILES_SIZE * i, Game.TILES_SIZE * 12, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	}
//	g.drawImage(thung[0], Game.TILES_SIZE * 24, Game.TILES_SIZE * 11, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	g.drawImage(thung[0],Game.TILES_SIZE*16,Game.TILES_SIZE*8,Game.TILES_SIZE,Game.TILES_SIZE,null);
//	g.drawImage(thung[0],Game.TILES_SIZE*9,Game.TILES_SIZE*12,Game.TILES_SIZE,Game.TILES_SIZE,null);
		/*------------bom_off-------*/
//	g.drawImage(bom_off[0], Game.TILES_SIZE * 19, Game.TILES_SIZE * 4, Game.TILES_SIZE, Game.TILES_SIZE, null);
//	g.drawImage(bom_off[0],Game.TILES_SIZE*9,Game.TILES_SIZE*11,Game.TILES_SIZE,Game.TILES_SIZE,null);
//
